...
public final class SSA<V, E> {
    ...
    // place part
    protected Set<Integer> variables = new HashSet<>();
    // rename part
    ...
    private void place() {
        final Map<Integer, Set<SSABlockNode<V>>> defsites = new HashMap<>();
        // variables defined in n
        final Map<SSABlockNode<V>, Set<Integer>> a_orig = new HashMap<>();
        ...
        final Map<SSABlockNode<V>, Set<Integer>> a_phi = new HashMap<>();
        ...
        for (int a : variables) {
            LinkedList<SSABlockNode<V>> w = new LinkedList<>();
    ...
    private void rename() {
        ...
        Set<SSABlockNode<V>> preBlock = new HashSet<>();
        if (end != null) {
